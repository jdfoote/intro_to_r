...
# We will be using the 'dplyr' library and syntax, so we need to install it.
...
# The dataset includes four daataframes. Dataframes are sort of like R's version of spreadsheets.
# The head command shows us the first few rows of each dataframe.
head(flights)
head(airlines)
head(weather)
head(planes)
